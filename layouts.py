...
def churn_data_tab():
    return html.Div([
        ...
        html.Br(),
        html.H6(children=["Select Dataset to be Displayed"], style={
            'text-align': 'center'}),
        html.Div([
            dcc.Dropdown(
                id='dropdown-table',
        ...
        html.Br(),
        html.H6(children=["Select Columns to Display In table"], style={
            'text-align': 'center'}),
...
def tab_layout():
    return html.Div([
        dcc.Tabs(id='tabs-example', value='tab-1', children=[
            ...
            dcc.Tab(label='Churn Data', value='tab-2', style=tab_style, selected_style=tab_selected_style, children=[
                churn_data_tab()
            ]),

            # Churn Model Tab
            dcc.Tab(label="Churn Model", value='tab-3', style=tab_style, selected_style=tab_selected_style, children=[
